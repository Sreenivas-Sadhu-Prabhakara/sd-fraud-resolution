package com.bank.bian.fraudresolution.model;
...
/**
 * The BIAN control record for this service domain: "Fraud Resolution Procedure".
 *
 ...
 * to its asset type (Fraud Resolution). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Fraud Resolution Procedure";
